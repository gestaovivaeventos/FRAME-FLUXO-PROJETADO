  ...
  const groups: DashboardGroup[] = [
    ...
    },
    {
      ...
      dashboards: [
        ...
        { id: 'fluxo-projetado', label: 'Fluxo Projetado', path: '/fluxo-projetado', icon: 'flow' },
      ],
    },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        {/* Navigation */}
        <nav 
          className="p-3 h-[calc(100vh-8rem)] lg:h-[calc(100vh-140px)]"
          style={{
            overflowY: 'auto',
            overflowX: 'hidden',
            scrollbarWidth: 'thin',
            scrollbarColor: '#FF6600 #2d3139',
          }}
        >
          <style jsx>{`
